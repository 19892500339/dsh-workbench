...
#### 🧬 类型 `WorkbenchState` · L199-L227
- 签名: `export interface WorkbenchState {`

#### 🧬 类型 `McpConnectionStatus` · L230-L235
- 签名: `export interface McpConnectionStatus {`

#### 🧬 类型 `StateSnapshot` · L238-L246
