...
const zh: Dict = {
  ...
  wfRunScript: '脚本运行', wfRunScriptBtn: '运行脚本', wfRunScriptNote: '启动后即返回 runId, 面板轮询实时进度; 可随时取消。',
  ...
  // V4.1: canvas editing + fullscreen + progress + confirmation
  wfEditNode: '编辑节点', wfNodeLabel: '节点名称', wfNodeKind: '类型', wfNodeParams: '参数',
  wfParamLabel: '标签', wfParamText: '提示词正文', wfParamOp: '操作', wfParamValue: '内容',
  wfParamOpAppend: '追加', wfParamOpPrepend: '前置', wfParamOpReplace: '替换',
  wfParamSearch: '查找', wfParamFormat: '输出格式', wfParamToolName: '工具', wfParamToolArgs: '入参 JSON',
  wfParamSkillName: '技能', wfDeleteNode: '删除节点', wfCancelRun: '取消运行',
  wfRunning: '运行中… 轮询进度', wfProgress: '运行进度', wfNoProgress: '暂无进度事件',
  wfUnsaved: '有未保存的修改, 切换将丢失。确定继续?', wfConfirmDeleteWorkflow: '确定删除该工作流?',
  wfConfirmRestore: '恢复内置模板会覆盖同名工作流, 确定继续?', wfOutputFull: '完整输出',
  wfFullscreenEnter: '全屏查看/编辑 (Esc 也可退出)', wfFullscreenExit: '退出全屏',
  wfEditHint: '点击节点可编辑名称与参数', wfParamsEditHint: '编辑后需点击「保存」生效',
  wfProgressPhase: '阶段', wfProgressAgent: '子代理', wfProgressLog: '日志',
  wfAgentCompleted: '完成', wfAgentFailed: '失败', wfAgentCancelled: '已取消', wfAgentRunning: '运行中',
  wfRunCancelNote: '取消会终止当前运行并释放子代理。',
  wfNoSelEdit: '在画布中点击一个节点以编辑。',
  wfDeleteConfirm: '确定删除节点「{label}」?',
  wfToggleFullscreen: '切换全屏',
  wfDirty: '● 未保存',
...
const en: Dict = {
  ...
  wfRunScript: 'Script run', wfRunScriptBtn: 'Run script', wfRunScriptNote: 'Starts immediately and returns a runId; the panel polls live progress and can cancel anytime.',
  ...
  // V4.1: canvas editing + fullscreen + progress + confirmation
  wfEditNode: 'Edit node', wfNodeLabel: 'Node name', wfNodeKind: 'Kind', wfNodeParams: 'Params',
  wfParamLabel: 'Label', wfParamText: 'Prompt body', wfParamOp: 'Op', wfParamValue: 'Value',
  wfParamOpAppend: 'append', wfParamOpPrepend: 'prepend', wfParamOpReplace: 'replace',
  wfParamSearch: 'Search', wfParamFormat: 'Output format', wfParamToolName: 'Tool', wfParamToolArgs: 'Args JSON',
  wfParamSkillName: 'Skill', wfDeleteNode: 'Delete node', wfCancelRun: 'Cancel run',
  wfRunning: 'Running… polling progress', wfProgress: 'Run progress', wfNoProgress: 'No progress events yet',
  wfUnsaved: 'Unsaved changes will be lost if you switch. Continue?', wfConfirmDeleteWorkflow: 'Delete this workflow?',
  wfConfirmRestore: 'Restoring templates overwrites same-name workflows. Continue?', wfOutputFull: 'Full output',
  wfFullscreenEnter: 'Fullscreen view/edit (Esc exits)', wfFullscreenExit: 'Exit fullscreen',
  wfEditHint: 'Click a node to edit its name and params', wfParamsEditHint: 'Click "Save" to apply edits',
  wfProgressPhase: 'Phase', wfProgressAgent: 'Subagent', wfProgressLog: 'Log',
  wfAgentCompleted: 'done', wfAgentFailed: 'failed', wfAgentCancelled: 'cancelled', wfAgentRunning: 'running',
  wfRunCancelNote: 'Cancelling terminates the run and releases subagents.',
  wfNoSelEdit: 'Click a node on the canvas to edit it.',
  wfDeleteConfirm: 'Delete node "{label}"?',
  wfToggleFullscreen: 'Toggle fullscreen',
  wfDirty: '● unsaved',
